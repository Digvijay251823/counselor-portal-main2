...
export function NOR({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="NOR">
        {label}
      ...
      <input
        ...
        className={`rounded px-4 py-2 text-lg border transition-all duration-500 ${
          state.theme.theme === "LIGHT"
            ...
            : "focus:border-purple-300 outline-none focus:ring-4 focus:ring-purple-950 bg-stone-950 border-stone-800"
        }`}
        required
      />
    </div>
...
//   return (
//     <div className="flex flex-col gap-1 w-full">
//       <label className="font-bold text-lg" htmlFor="EJRB8A">
//         {label}
//         <i className="text-red-400">*</i>
//       </label>
//       <input
...
//   return (
//     <div className="flex flex-col gap-1 w-full">
//       <label className="font-bold text-lg" htmlFor="AJRA8A">
//         {label}
//         <i className="text-red-400">*</i>
//       </label>
//       <input
...
export function F8RCT({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="F8RCT">
        {label}
        <i className="text-red-400">*</i>
      </label>
...
export function N8RCT({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="N8RCT">
        {label}
        <i className="text-red-400">*</i>
      </label>
      <input
...
export function WUT({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="WUT">
        {label}
        <i className="text-red-400">*</i>
      </label>
...
export function ST({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="ST">
        {label}
        <i className="text-red-400">*</i>
      </label>
...
export function PBR({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="PBR">
        {label}
...
export function PCH({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="PCH">
        {label}
        <i className="text-gray-500 font-normal">in minutes</i>
        <i className="text-red-400">*</i>
      </label>
...
export function GCH({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="GCH">
        {label}
        <i className="text-gray-500 font-normal">in minutes</i>
        <i className="text-red-400">*</i>
      </label>
...
export function CH({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="CH">
        {label}
        <i className="text-gray-500 font-normal">in minutes</i>
        <i className="text-red-400">*</i>
      </label>
...
export function S({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="S">
        {label}
        <i className="text-red-400">*</i>
      </label>
      <input
...
export function AA({
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="AA">
        {label}
        <i className="text-red-400">*</i>
      </label>
...
export function MIU({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="MIU">
        {label}
        <i className="text-gray-500 font-normal">in minutes</i>
        <i className="text-red-400">*</i>
      </label>
...
export function T({ label }: { label: string }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="T">
        {label}
        <i className="text-gray-500 font-normal">in minutes</i>
        <i className="text-red-400">*</i>
      </label>
      <input
        ...
        name="topic"
        id="T"
        placeholder="Topic You Are Nowdays Reading"
        className={`rounded px-4 py-2 text-lg border transition-all duration-500 ${
          state.theme.theme === "LIGHT"
            ? "focus:border-purple-600 outline-none focus:ring-4 focus:ring-purple-100 bg-white border-gray-300"
            : "focus:border-purple-300 outline-none focus:ring-4 focus:ring-purple-950 bg-stone-950 border-stone-800"
...
export function VS({
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      <label className="font-bold text-lg" htmlFor="VS">
        {label}
        <i className="text-red-400">*</i>
      </label>
      <div className="relative inline-block text-left" ref={menuRef}>
...
export const FormListItems = [
  ...
  {
    id: 4,
    type: "Guru Maharaj Class Hearing Time",
    valueType: "Number",
    functionName: "GCH",
  ...
  {
    id: 9,
    type: "Prabhupada Book Reading Time",
    valueType: "Number",
    functionName: "PBR",
  ...
  {
    id: 10,
    type: "Prabhupada Class Hearing Time",
    valueType: "Number",
    functionName: "PCH",
  ...
  {
    id: 15,
    type: "Visible Sadhana",
    valueType: "Text",
    functionName: "VS",
    databaseField: "visibleSadhana",
  },
];
